...
export const PrivacyPolicyPage: React.FC = () => {
  return (
    <div className="animate-fade-in bg-white rounded-2xl shadow-xl p-6 sm:p-10 border border-gray-200">
      <div className="prose prose-lg max-w-none text-gray-700 prose-headings:font-bold prose-headings:text-gray-800 prose-a:text-indigo-600 hover:prose-a:text-indigo-500">
